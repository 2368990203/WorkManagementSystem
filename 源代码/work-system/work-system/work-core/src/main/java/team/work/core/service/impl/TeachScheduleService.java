...
import team.work.core.mapper.TeachScheduleMapper;
import team.work.core.model.TeachSchedule;
import team.work.core.service.ITeachScheduleService;
...
@Service
public class TeachScheduleService extends TServiceImpl<TeachScheduleMapper,TeachSchedule> implements ITeachScheduleService {
   /**************************CURD begin******************************/ 
   // 创建
   @Override
   public TeachSchedule createTeachSchedule(TeachSchedule model) {
   ...
   // 删除
   @Override
   public Boolean deleteTeachSchedule(Object ids,String reviser) {
       return this.delete(ids,reviser);
   }
 
   // 修改
   @Override
   public TeachSchedule updateTeachSchedule(TeachSchedule model) {
   ...
   // 查询
   @Override
   public List<TeachSchedule> findByIds(Object ids) {
