        ...
        this.insertImages = function (files) {
            $.each(files, function (idx, file) {
                ...
                if (options.maximumImageFileSize && options.maximumImageFileSize < file.size) {
                    ...
                    var _file = file;
                    var _fileName = 'article/'+string.random() + getSuffix(filename);
    ...
    var ImageDialog = function (context) {
        ...
        this.initialize = function () {
            ...
            var body = '<div class="form-group note-group-select-from-files">' +
                ...
                '<input class="note-image-input form-control" type="file" name="files" accept="image/.jpg,.png,.jpeg,.gif" />' +
                imageLimitation +
                '</div>';
    ...
    var VideoDialog = function (context) {
        ...
        this.createVideoNode = function (url) {
            ...
            if (ytMatch && ytMatch[1].length === 11) {
                ...
                // this is not a known local link. Now what, Cat? Now what?
                return false;
            }

            $local.addClass('note-local-clip');
        ...
        this.show = function () {
            ...
            context.invoke('editor.saveRange');
            this.showlocalDialog(text).then(function (url) {
                // [workaround] hide dialog before restore range for IE range focus
                ui.hideDialog(self.$dialog);
                context.invoke('editor.restoreRange');

                // build node
                var $node = self.createlocalNode(url);
