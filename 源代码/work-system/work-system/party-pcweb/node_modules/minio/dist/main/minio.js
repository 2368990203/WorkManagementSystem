...
var Client = (function () {
  ...
  _createClass(Client, [{
    ...
    value: function listObjectsV2Query(bucketName, prefix, continuationToken, delimiter, maxKeys, startAfter) {
      ...
      if (!(0, _helpersJs.isString)(startAfter)) {
      ...
      // Set start-after
      if (startAfter) {
        startAfter = (0, _helpersJs.uriEscape)(startAfter);
    ...
    value: function removeObjects(bucketName, objectsList, cb) {
      ...
      _async2['default'].eachSeries(result.listOfList, function (list, callback) {
        ...
        _this11.makeRequest({ method: method, bucketName: bucketName, query: query, headers: headers }, payload, 200, '', false, function (e) {
    ...
    value: function presignedUrl(method, bucketName, objectName, expires, reqParams, requestDate, cb) {
      ...
      if ((0, _helpersJs.isFunction)(requestDate)) {
        cb = requestDate;
      ...
      if (!(0, _helpersJs.isValidDate)(requestDate)) {
