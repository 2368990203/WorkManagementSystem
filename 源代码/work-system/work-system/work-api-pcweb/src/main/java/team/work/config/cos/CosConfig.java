...
public class CosConfig {
     ...
     */
    private String appSignatureBase(Credentials cred, String bucketName, String cosPath, long expired,
     ...
     * @throws AbstractCosException
     */
    public String getPeriodEffectiveSign(String bucketName, String cosPath, Credentials cred, long expired)
            throws AbstractCosException {
     ...
     * @throws AbstractCosException
     */
    public String getOneEffectiveSign(String bucketName, String cosPath, Credentials cred)
            throws AbstractCosException {
     ...
     * @throws AbstractCosException
     */
    public String getDownLoadSign(String bucketName, String cosPath, Credentials cred, long expired)
            throws AbstractCosException {
