...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object o) throws Exception {
        ...
        if (V.isEqual(method.toLowerCase(), "get")) {
            ...
            //公共接口
            String[] commonApis = {};
            for (String except : commonApis) {
                if (V.isEqual(cls[0], except)) {
                    i = 1;
                    break;
                }
            }
            ...
            //网课相关接口 ->映射到网课接口
            String[] courseApis = {"SectionUserApi", "OnlineCourseUserApi", "ChapterUserApi", "ChapterApi", "SectionApi"};
            //PictureApi VideoApi
            for (String except : courseApis) {
                if (V.isEqual(cls[0], except)) {
                    cls[0] = "OnlineCourseApi";
                }
            }
