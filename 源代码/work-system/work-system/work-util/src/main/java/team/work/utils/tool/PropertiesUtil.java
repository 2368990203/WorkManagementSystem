...
public class PropertiesUtil {
    ...
    public void writeProperty(String key, String value) {
        ...
        try {
            ...
            //System.out.println(PropertiesUtil.class.getClassLoader().getResource(properiesName).getFile());
    ...
    public static void main(String[] args) {
		...
		System.out.println("更改前："+p.readProperty("names"));

		p.writeProperty("namess", "wang");

		System.out.println("更改后："+p.readProperty("names"));
